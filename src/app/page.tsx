...
export default async function HomePage() {
  ...
  const lieuxAffiches = (lieux ?? []).slice(0, 3)
  ...
  return (
    <>
      ...
      <section className="bg-navy min-h-[85vh] pt-16 flex flex-col">
        <div className="flex-1 flex items-center">
          <div className="max-w-7xl mx-auto px-6 py-10 w-full">
            <div className="grid md:grid-cols-2 gap-16 items-center">
              ...
              {/* Mosaïque photos — composition libre */}
              <div className="relative hidden md:block" style={{ height: '480px' }}>
                {/* Photo principale — grande, légèrement inclinée à gauche */}
                {heroPhotos[0] && (
                  <div
                ...
                {/* Photo top-right — petite, inclinée à droite */}
                {heroPhotos[1] && (
                  <div
                ...
                {/* Photo bottom-right — chevauchement */}
                {heroPhotos[3] && (
                  <div
                    className="absolute rounded-xl overflow-hidden shadow-xl border-2 border-white/20"
        ...
        {/* Barre de recherche — chevauche la section suivante */}
                ...
                >
                  <div className="flex items-center gap-0.5">
                    {Array.from({ length: 5 }, (_, i) => (
                      <span key={i} className={`text-lg ${i < a.note ? 'text-brand' : 'text-gray-200'}`}>
                        ★
                      </span>
                    ))}
                  </div>
