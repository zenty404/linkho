...
function getAnimationValues(width: number) {
  if (width >= 1280) {
    return {
      div1TranslateY: '-1030px',
      div1TranslateX: '670px',
      div2TranslateY: '-1050px',
      div2TranslateX: '120px',
      div3TranslateY: '-1590px',
      div3TranslateX: '670px',
      div4TranslateY: '-1610px',
      div4TranslateX: '125px',
    ...
    return {
      div1TranslateY: '-1000px',
      div1TranslateX: '650px',
      div2TranslateY: '-1010px',
      div2TranslateX: '140px',
      div3TranslateY: '-1550px',
      div3TranslateX: '650px',
      div4TranslateY: '-1570px',
      div4TranslateX: '140px',
      textTranslateY: '-180px',
      textOpacity: 0,
      textScale: 0.75,
      divScale: 0.75
    ...
    return {
      div1TranslateY: '-950px',
      div1TranslateX: '620px',
      div2TranslateY: '-970px',
      div2TranslateX: '140px',
      div3TranslateY: '-1450px',
      div3TranslateX: '620px',
      div4TranslateY: '-1480px',
      div4TranslateX: '140px',
      textTranslateY: '-180px',
      textOpacity: 0,
      textScale: 0.75,
    ...
    return {
      div1TranslateY: '-980px',
      div1TranslateX: '580px',
      div2TranslateY: '-990px',
      div2TranslateX: '140px',
      div3TranslateY: '-1460px',
      div3TranslateX: '580px',
      div4TranslateY: '-1480px',
      div4TranslateX: '140px',
      textTranslateY: '-180px',
      textOpacity: 0,
